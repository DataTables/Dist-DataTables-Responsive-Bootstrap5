...
h=new bootstrap.Modal(f[0]);c.modal=function(k){return function(l,g,m){if(!a.fn.modal)d(l,g,m);else if(!g){if(k&&k.header){g=f.find("div.modal-header");var n=g.find("button").detach();g.empty().append('<h4 class="modal-title">'+k.header(l)+"</h4>").append(n)}f.find("div.modal-body").empty().append(m());f.appendTo("body").modal();h.show()}}};return b.Responsive});
